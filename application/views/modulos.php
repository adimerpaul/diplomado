            ...
            <div class="modal-body">
                <form method="post" action="<?=base_url()?>Modulos/update">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select id="iddocente" type="text" class="form-control" placeholder="iddocente" name="iddocente" required>
                                <option value="">Seleccionar...</option>
                                <?php
                                $query=$this->db->query("SELECT * FROM docente d 
INNER JOIN persona p ON p.idpersona=d.idpersona");
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <select id="idprograma" type="text" class="form-control" placeholder="idprograma" name="idprograma" required>
                                <option value="">Seleccionar...</option>
                                <?php
                                $query=$this->db->query("SELECT * FROM programa WHERE estado='ACTIVO'");
                                foreach ($query->result() as $row){
